        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (doc.exists) {
                    ...
                    throw new not_found_error_1.NotFoundError("Usuário não encontrado para Busca.");
                }
            }
            catch (error) {
                next(error);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if ((yield docRef.get()).exists) {
                    ...
                    throw new not_found_error_1.NotFoundError("Usuário não encontrado para Update");
                }
            }
            catch (error) {
                next(error);
